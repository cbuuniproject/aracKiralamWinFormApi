...
{
    public partial class frm_RolEkle : Form
    {
        public frm_RolEkle()
        {
            InitializeComponent();
		...
		private async void btnRolEkle_ClickAsync(object sender, EventArgs e)
		{
			try
			{
				bool success = false;
				...
				using (var client = new HttpClient())
				{
					...
					Rol rol = new Rol { rolAdı = txtRolAd.Text };
					...
					var result = await client.PostAsync("api/Rol", content);
					// Check for result
